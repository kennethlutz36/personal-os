(()=>{
  ...
  // While Personal OS is open, keep iCloud close to live. Force exactly one refresh after parser upgrades.
  setTimeout(()=>{injectLiveBar();syncApple(parserNeedsSync(),false)},2500);
